...
#ifndef CONFUSIONMATRIX_PROT_HPP
#define CONFUSIONMATRIX_PROT_HPP

/**
  The ConfusionMatrix class.
*/
class ConfusionMatrix_prot {
    public:
        /**
          The standard constructor.
        */
        ConfusionMatrix_prot();
        /**
        ...
        */
        ...
        /**
          Adding all the observations from another confusion matrix.
        */
        void AddMatrix(ConfusionMatrix_prot other);
...
#endif    // END_CONFUSIONMATRIX_PROT_HPP
